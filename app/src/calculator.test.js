...
test('sum with multiple arguments returns sum', () => {
...
test('subtract with two arguments returns difference', () => {
...
test('multiply with multiple arguments returns product', () => {
...
test('divide with zero divisor throws error', () => {
...
test('average with one argument returns that argument', () => {
...
test('percent with zero value returns 0', () => {
  expect(percent(0, 100)).toBe(0)
})

test('percent with zero of returns 0', () => {
  expect(percent(50, 0)).toBe(0)
})

test('percent with negative value works correctly', () => {
  expect(percent(-50)).toBe(-0.5)
})

test('percent with negative of works correctly', () => {
  expect(percent(50, -100)).toBe(-50)
})

test('sum with zero argument returns 0', () => {
  expect(sum(0)).toBe(0)
})

test('subtract with zero argument returns 0', () => {
  expect(subtract(0)).toBe(0)
})

test('multiply with zero argument returns 0', () => {
  expect(multiply(0)).toBe(0)
})

test('divide with zero dividend returns 0', () => {
  expect(divide(0, 5)).toBe(0)
})

test('average with zero argument returns 0', () => {
